...
Realiza una programa que permita realizar una compra de X cantidad de productos almacenando nombre, Cantidad, y precio de cada uno y calcule y muestre.

Anota el bloque de codigo del programa que muestre el proceso para calcular el resultado de dsumar los numeros de una serie numerica 